...
INSERT INTO `tbl_user` (`nik`, `nama`, `username`, `password`, `telp`) VALUES
('12345', 'candra', 'candra', '$2y$10$5AO0gGQOpsQVN9b0qYGF3O0KMceqOocfi1tQEtZCoWjpzqMBKdpji', '085157'),
('12345678', 'Candra saputra', 'armin', '$2y$10$S/kPnmqJIw0y2RO6kKyrbOuEOMW92CBLWDfFQDZUsAvJSHgzOHqBO', '089');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbl_poktan`
--

CREATE TABLE `tbl_poktan` (
  `id_poktan` int(11) NOT NULL,
  `nama` varchar(35) NOT NULL,
  `dusun` varchar(35) NOT NULL,
  `desa` varchar(35) NOT NULL,
  `kecamatan` varchar(35) NOT NULL,
  `nama_ketua` varchar(35) NOT NULL,
  `nik_ketua` varchar(20) NOT NULL
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbl_hibah`
--

CREATE TABLE `tbl_hibah` (
  `id_poktan` int(11) NOT NULL,
  `tahun_hibah` varchar(20) NOT NULL,
  `jenis_hibah` varchar(20) NOT NULL,
