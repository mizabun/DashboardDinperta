            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="nav nav-pills">
                    @if (Auth::guard('masyarakat')->check())
                        ...
                        <li class="nav-item">
                            <a href="/logoutmasyarakat" class="nav-link bg-custom rounded tebel-sedang shadow"
                                id="btn-sign">LOG OUT</a>
                        </li>
                    @else
                        <li class="nav-item">
                            <a href="/login" class="nav-link bg-custom rounded tebel-sedang shadow" id="btn-sign">SIGN
                                IN</a>
                        </li>
                    @endif
                </ul>
