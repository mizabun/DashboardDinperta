    ...
    <div class="container">
        ...
        <div class="row mt-5 mb-5">
            ...
            <div class="col-sm-12 position-relative p-4">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h5 class="text-warning">Ayo! isi pengaduan sesuai yang ingin kalian sampaikan</h5>
                            ...
                            <div class="card-body">
                                <form action="/prosespengaduan" class="row" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12 mt-4 mb-2">
                                        <img src="{{ asset('assets/img/nonimage.jpg') }}" width="200"
                                            class="img-thumbnail mr-3" align="left" id="preview">
                                    </div>
                                    <div class="col-md-12"></div>

                                    <div class="col-md-12 mb-3">
                                        <label>Pilih Gambar Yang Ingin anda Masukkan</label>
                                        <div class="form-group">
                                            <div class="custom-file">
                                                <input name="gambar_masakan" type="file"
                                                    accept="image/x-png,image/gif,image/jpeg" class="form-control"
                                                    id="inputGambar_masakan" placeholder=" masukan file gambar buku"
                                                    name="gambar">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 mt-5">
                                        <button href="" class="btn btn-warning btn-block mb-3 shadow text-light">Isi
                                            pengaduan</button>
                                    </div>
                                </form>
                            </div>
