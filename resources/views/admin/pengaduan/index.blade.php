@extends('admin/layout.master', ['title' => 'Pengaduan'])
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->status == 'terkirim')
                                                <a href="{{ route('pengaduan.proses', $item->id_pengaduan) }}"
                                                    class="btn btn-primary"><i class="fas fa-keyboard"></i> Diproses</a>
                                            @elseif($item->status == 'proses')
                                                <a href="{{ route('pengaduan.selesai', $item->id_pengaduan) }}"
                                                    class="btn btn-success"><i class="fas fa-check"></i> Selesaikan</a>
                                            @else
                                            @endif
                                            <a href="{{ route('pengaduan.tanggapan', $item->id_pengaduan) }}"
                                                class="btn btn-warning"><i class="far fa-comment-dots"></i> Tanggapi</a>
                                        </td>
                                    </tr>
                                    @push('page-scripts')
