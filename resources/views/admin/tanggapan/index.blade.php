@extends('admin/layout.master', ['title' => 'Tanggapan'])
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" data-id=""
                                                class="btn btn-danger confirm_script-{{ $item->id_tanggapan }} mr-3 mb-1">
                                                <form action="{{ route('tanggapan.destroy', $item->id_tanggapan) }}"
                                                    class="delete_form-{{ $item->id_tanggapan }}" method="POST">
                                                    @method('DELETE')
                                                    @csrf
                                                </form>
