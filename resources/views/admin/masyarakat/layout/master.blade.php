        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="nav nav-pills">
                    <li class="nav-item">
                        <a class="nav-link active bg-active link-navbar tebel-sedang"href="#">Home
                            &nbsp;&nbsp;</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link bg-custom rounded tebel-sedang shadow" id="btn-sign">SIGN
                            UP</a>
                    </li>
                </ul>
            </div>
    ...
    <div class="container">
        ...
        <div class="row mt-5 mb-5">
            ...
            <div class="col-sm-12 position-relative p-4">
                ...
                <div class="desc mt-4">
                    <p>Lorem ipsum dolor sit smaehi Lorem ipsum dolor sit smaehi Lorem ipsum dolor sit smaehi Lorem
                        ipsum dolor sit smaehi Lorem ipsum dolor sit smaehi Lorem ipsum dolor sit smaehi</p>
                </div>
