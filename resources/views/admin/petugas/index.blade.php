@extends('admin/layout.master', ['title' => 'Petugas'])
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        {{-- Button tambah --}}
                        <a href="{{ route('petugas.create') }}" class="btn btn-warning mb-4"><i
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" data-id=""
                                                class="btn btn-danger confirm_script-{{ $item->id_petugas }} mr-3">
                                                <form action="{{ route('petugas.destroy', $item->id_petugas) }}"
                                                    class="delete_form-{{ $item->id_petugas }}" method="POST">
                                                    @method('DELETE')
                                                    @csrf
                                                </form>
